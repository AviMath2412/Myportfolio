...
export const ContainerTextScroll = ({
    ...
    const translateY = useTransform(scrollYProgress, [0, 0.5], [100, 0]); // moves up
    const titleTranslateY = useTransform(scrollYProgress, [0, 0.5], [100, 0]);
...
export const Card = ({
    ...
    return (
        <motion.div
            ...
            className="relative h-[30rem] md:h-[40rem] w-full border border-white/10 bg-black/40 backdrop-blur-sm rounded-[30px] shadow-2xl overflow-hidden"
        >
